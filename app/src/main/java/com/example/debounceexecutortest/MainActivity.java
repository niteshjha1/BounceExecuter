...
public class MainActivity extends Activity {
    ...
    private com.example.debounceexecutortest.SharedPreferencesHelper mSharedPreferencesHelper;
    ...
    private com.example.debounceexecutortest.EmailValidator mEmailValidator;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailValidator = new com.example.debounceexecutortest.EmailValidator();
        mEmailText.addTextChangedListener(mEmailValidator);
        // Instantiate a SharedPreferencesHelper.
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(this);
        mSharedPreferencesHelper = new com.example.debounceexecutortest.SharedPreferencesHelper(sharedPreferences);
    ...
    private void populateUi() {
        com.example.debounceexecutortest.SharedPreferenceEntry sharedPreferenceEntry;
    ...
    public void onSaveClick(View view) {
        ...
        com.example.debounceexecutortest.SharedPreferenceEntry sharedPreferenceEntry =
                new com.example.debounceexecutortest.SharedPreferenceEntry(name, dateOfBirth, email);
